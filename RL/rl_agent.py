...
class RLAgent:
    def __init__(self, state_dim, action_dim, lr_actor=0.0003, lr_critic=0.001, gamma=0.99, K_epochs=80, eps_clip=0.2, has_continuous_action_space=True, action_std_init=0.6):
        print("============================================================================================")

        ####### initialize environment hyperparameters ######
        self.has_continuous_action_space = has_continuous_action_space  # continuous action space; else discrete
        ...
        self.action_std = action_std_init                    # starting std for action distribution (Multivariate Normal)
    ...
    def train(self):
        ...
        log_f_name = self.log_dir + '/PPO_' + env_name + "_log_" + str(run_num) + ".csv"
