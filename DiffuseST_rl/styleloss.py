...
style_image_path = "./images/style/van_gogh.png"
...
frame_folder = "./output_baseline/train"
loss_fn = nn.MSELoss()
with torch.no_grad():
...
for subfolder in os.listdir(frame_folder):
    if not subfolder.startswith("frames_"):
        continue    
    else:
        video_folder = os.path.join(frame_folder, subfolder)
